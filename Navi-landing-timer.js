  const timerCode = `(function() {
        ...
        function updateTimer() {
            ...
            timerElement.setAttribute('data-ph-no-capture', '');
    ...
    const timerElement = document.getElementById('start_timer');
    if (timerElement) {
